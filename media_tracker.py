# ============================================================
# ULTIMATE MEDIA TRACKER — Fully Refactored
# Fixes: search trigger, double AniList calls, bare excepts,
#        magic numbers, sheet.find() safety, import re position
# New:   Personal rating, Notes, Progress bars, Stats tab,
#        Recently Added, CSV export, On Hold status, rate limiter
# ============================================================
